...
export function ProductGallery({ mainImage, images = [], productName }: ProductGalleryProps) {
  ...
  if (allImages.length === 1) {
    return (
      <div className="relative aspect-[3/4] bg-gradient-to-br from-brand-sand to-brand-ivory rounded-premium overflow-hidden">
        {mainImage ? (
          <Image
            src={mainImage}
            alt={productName}
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <svg className="w-24 h-24 text-brand-nude" fill="currentColor" viewBox="0 0 24 24">
