...
import { CONTACT, SOCIALS } from '@/constants/brand';
            ...
            <div className="flex justify-center gap-6">
              {SOCIALS.instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-14 h-14 bg-[#0a0a0a] text-white rounded-full flex items-center justify-center hover:bg-[#d4a853] hover:text-[#0a0a0a] transition-colors"
                >
